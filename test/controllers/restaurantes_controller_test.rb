...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { endereco: @restaurante.endereco, nome: @restaurante.nome, telefone: @restaurante.telefone } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { endereco: @restaurante.endereco, nome: @restaurante.nome, telefone: @restaurante.telefone } }
